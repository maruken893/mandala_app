...
### 作りたいもの
目標達成シート(マンダラチャート)をwebアプリケーション内で管理し、同じような目標をもつ他のユーザーと交流できるようなプラットフォーム。

### 動機
- スポーツ選手の目標達成シートを見て、やることや意識することを自分で考え明確化することで効率的に物事に取り組めると思い、誰でも使えるアプリケーションとして実現したい
...
2\. 404ページ
<br>
 - 存在しないURLにアクセスが来た際の404ページを作成しました。404ページにはbackというホームに遷移するリンクがあります。
<br>
